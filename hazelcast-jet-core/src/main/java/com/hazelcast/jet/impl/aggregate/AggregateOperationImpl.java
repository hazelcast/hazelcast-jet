...
public class AggregateOperationImpl<A, R> extends AggregateOperationBase<A, R> implements AggregateOperation<A, R> {
    ...
    @Nonnull
    @SuppressWarnings("unchecked")
    static <A> Map<Tag, DistributedBiConsumer<? super A, ?>> accumulatorsByTag(
            Object... tagsAndAccs
    ) {
    ...
    public static class Arity1<T1, A, R>
        ...
        Arity1(@Nonnull DistributedSupplier<A> createAccumulatorF,
        ...
        @Nonnull @Override
        public DistributedBiConsumer<? super A, T1> accumulateItemF1() {
        ...
        public <R1> AggregateOperation1<T1, A, R1> withFinish(
            ...
            return new AggregateOperationImpl.Arity1<>(
    ...
    public static class Arity2<T1, T2, A, R>
        ...
        Arity2(@Nonnull DistributedSupplier<A> createAccumulatorF,
               @Nonnull DistributedBiConsumer<? super A, T1> accumulateItemF1,
        ...
        public <R1> AggregateOperation2<T1, T2, A, R1> withFinish(
            ...
            return new AggregateOperationImpl.Arity2<>(
    ...
    public static class Arity3<T1, T2, T3, A, R>
        ...
        public <R1> AggregateOperation3<T1, T2, T3, A, R1> withFinish(
            ...
            return new AggregateOperationImpl.Arity3<>(
