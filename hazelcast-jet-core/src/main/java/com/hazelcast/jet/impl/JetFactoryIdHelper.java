...
public final class JetFactoryIdHelper {
    ...
    public static final String JET_OBSERVABLE_DS_FACTORY = "hazelcast.serialization.ds.jet.observable";
    public static final int JET_OBSERVABLE_DS_FACTORY_ID = -10006;
