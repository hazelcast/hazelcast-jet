 ...
 */
public class UrlYamlJetConfig extends JetConfig {

    private static final ILogger LOGGER = Logger.getLogger(UrlYamlJetConfig.class);

    /**
     * Creates new Config which is loaded from the given url and uses the System.properties to replace
     * variables in the YAML.
     *
     * @param url the url pointing to the Hazelcast Jet YAML file
     ...
     */
    public UrlYamlJetConfig(String url) throws IOException {
        this(new URL(url));
    }
     ...
     *
     * @param url        the url pointing to the Hazelcast Jet Jet YAML file
     ...
     * @throws InvalidConfigurationException if the YAML content is invalid
     */
    public UrlYamlJetConfig(String url, Properties properties) throws IOException {
     ...
     * @throws InvalidConfigurationException if the YAML content is invalid
     */
    public UrlYamlJetConfig(URL url) throws IOException {
     ...
     * @throws InvalidConfigurationException if the YAML content is invalid
     */
    public UrlYamlJetConfig(URL url, Properties properties) throws IOException {
