...
/**
 * A {@link JetConfig} which is initialized by loading an XML configuration file from the classpath.
 *
...
public class ClasspathXmlJetConfig extends JetConfig {
     ...
     */
    public ClasspathXmlJetConfig(String resource) {
     ...
     * @throws InvalidConfigurationException if the XML content is invalid
     */
    public ClasspathXmlJetConfig(String resource, Properties properties) {
     ...
     * @throws InvalidConfigurationException if the XML content is invalid
     */
    public ClasspathXmlJetConfig(ClassLoader classLoader, String resource) {
     ...
     * @throws InvalidConfigurationException if the XML content is invalid
     */
    public ClasspathXmlJetConfig(ClassLoader classLoader, String resource, Properties properties) {
