...
/**
 * A {@link JetConfig} which is initialized by loading an Yaml configuration file from the classpath.
 *
 * @see FileSystemYamlJetConfig
 */
public class ClasspathYamlJetConfig extends JetConfig {

    private static final ILogger LOGGER = Logger.getLogger(ClasspathYamlJetConfig.class);
     ...
     */
    public ClasspathYamlJetConfig(String resource) {
     ...
     * @throws InvalidConfigurationException if the Yaml content is invalid
     */
    public ClasspathYamlJetConfig(String resource, Properties properties) {
     ...
     * @throws InvalidConfigurationException if the Yaml content is invalid
     */
    public ClasspathYamlJetConfig(ClassLoader classLoader, String resource) {
     ...
     * @throws InvalidConfigurationException if the Yaml content is invalid
     */
    public ClasspathYamlJetConfig(ClassLoader classLoader, String resource, Properties properties) {
