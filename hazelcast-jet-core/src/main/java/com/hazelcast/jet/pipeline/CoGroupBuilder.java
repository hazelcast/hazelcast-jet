 ...
 * Javadoc pending.
 */
public class CoGroupBuilder<K> {
    private final Map<TupleIndex<?>, StreamWithKeyExtractor<?, K>> streams = new HashMap<>();

    public <E> TupleIndex<E> add(PStream<E> s, DistributedFunction<E, K> keyF) {
        TupleIndex<E> k = new TupleIndex<>(streams.size());
