...
public class ProcessorsTest {
    ...
    public void mapUsingService() {
        TestSupport
                .verifyProcessor(Processors.mapUsingServiceP(
                        perProcessorService(() -> new int[1], arr -> assertEquals(6, arr[0])),
    ...
    public void mapUsingServiceAsync() {
        TestSupport
                .verifyProcessor(mapUsingServiceAsyncP(
                        perProcessorService(AtomicInteger::new, ctx -> assertEquals(6, ctx.get())),
                        t -> "k",
    ...
    public void filteringWithMapUsingService() {
        TestSupport
                .verifyProcessor(Processors.mapUsingServiceP(
                        perProcessorService(() -> new int[1], arr -> assertEquals(3, arr[0])),
    ...
    public void filteringWithMapUsingServiceAsync() {
        TestSupport
                .verifyProcessor(mapUsingServiceAsyncP(
                        perProcessorService(() -> new int[] {2}, arr -> assertEquals(2, arr[0])),
                        t -> "k",
                        (int[] context, Integer item) ->
    ...
    public void filterUsingService() {
        TestSupport
                .verifyProcessor(filterUsingServiceP(
                        perProcessorService(() -> new int[1], arr -> assertEquals(2, arr[0])),
                        (int[] context, Integer item) -> {
                            try {
    ...
    public void filterUsingServiceAsync() {
        TestSupport
                .verifyProcessor(filterUsingServiceAsyncP(
                        perProcessorService(AtomicInteger::new, ctx -> assertEquals(4, ctx.get())),
                        t -> "k",
    ...
    public void flatMapUsingService() {
        ...
        TestSupport
                .verifyProcessor(flatMapUsingServiceP(
                        perProcessorService(() -> context, c -> c[0] = 0),
