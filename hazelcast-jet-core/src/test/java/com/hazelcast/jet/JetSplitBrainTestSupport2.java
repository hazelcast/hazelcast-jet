...
// TODO [basri] rename class + javadoc
public abstract class JetSplitBrainTestSupport2 extends JetTestSupport {
    ...
    private void healSplitBrain(JetInstance[] instances, int firstSubClusterSize) {
        ...
        if (unblacklistHint) {
            applyOnBrains(instances, firstSubClusterSize, JetSplitBrainTestSupport2::unblacklistJoinerBetween);
        }
