...
import static com.hazelcast.jet.sql.impl.connector.kafka.MetadataJavaResolver.INSTANCE;
...
public class MetadataJavaResolverTest {
    ...
    public void test_resolvePrimitiveMetadata(boolean key, String path) {
        ...
        assertThat(metadata.getFields()).containsExactly(
                new KafkaTableField(path, QueryDataType.INT, QueryPath.create(path))
        );
