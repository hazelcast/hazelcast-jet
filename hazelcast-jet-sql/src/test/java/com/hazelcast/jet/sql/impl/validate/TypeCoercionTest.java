...
//                        "null", "Writing to top-level fields of type OBJECT not supported"),
                ...
                // SMALLINT
                TestParams.passingCase(1401, SMALLINT, VARCHAR, "cast(42 as smallint)", "42", "42"),
                ...
                // INTEGER
                TestParams.passingCase(1501, INTEGER, VARCHAR, "cast(42 as integer)", "42", "42"),
                ...
                TestParams.failingCase(1504, INTEGER, TINYINT, "cast(420 as integer)",
                        "420", "Numeric overflow while converting INTEGER to TINYINT"),
                ...
                TestParams.failingCase(1506, INTEGER, SMALLINT, "cast(420000 as integer)",
                        "420000", "Numeric overflow while converting INTEGER to SMALLINT"),
                ...
                // BIGINT
                TestParams.passingCase(1601, BIGINT, VARCHAR, "cast(42 as bigint)", "42", "42"),
                ...
                TestParams.failingCase(1604, BIGINT, TINYINT, "cast(420 as bigint)",
                        "420", "Numeric overflow while converting BIGINT to TINYINT"),
                ...
                TestParams.failingCase(1606, BIGINT, SMALLINT, "cast(420000 as bigint)",
                        "420000", "Numeric overflow while converting BIGINT to SMALLINT"),
                ...
                TestParams.failingCase(1608, BIGINT, INTEGER, "cast(4200000000 as bigint)",
                        "4200000000", "Numeric overflow while converting BIGINT to INTEGER"),
                ...
                // DECIMAL
                TestParams.passingCase(1701, DECIMAL, VARCHAR, "cast(42 as decimal)", "42", "42"),
                ...
                TestParams.failingCase(1704, DECIMAL, TINYINT, "cast(420 as decimal)",
                        "420", "Numeric overflow while converting DECIMAL to TINYINT"),
                ...
                TestParams.failingCase(1706, DECIMAL, SMALLINT, "cast(420000 as decimal)",
                        "420000", "Numeric overflow while converting DECIMAL to SMALLINT"),
                ...
                TestParams.failingCase(1708, DECIMAL, INTEGER, "cast(4200000000 as decimal)",
                        "4200000000", "Numeric overflow while converting DECIMAL to INTEGER"),
                ...
                TestParams.failingCase(1710, DECIMAL, BIGINT, "cast(9223372036854775809 as decimal)",
                        "9223372036854775809", "Numeric overflow while converting DECIMAL to BIGINT"),
                ...
                // REAL
                TestParams.passingCase(1801, REAL, VARCHAR, "cast(42 as real)", "42", "42"),
                ...
                // DOUBLE
                TestParams.passingCase(1901, DOUBLE, VARCHAR, "cast(42 as double)", "42", "42"),
                ...
                TestParams.passingCase(1913, DOUBLE, REAL, "cast(42e42 as double)", "42e42", Float.POSITIVE_INFINITY),
                ...
                // TIME
                TestParams.passingCase(2001, TIME, VARCHAR, "cast('01:42:00' as time)", "01:42:00", "01:42"),
                ...
                // DATE
                TestParams.passingCase(2101, DATE, VARCHAR, "cast('2020-12-30' as date)", "2020-12-30", "2020-12-30"),
                ...
                // TIMESTAMP
                TestParams.passingCase(2201, TIMESTAMP, VARCHAR, "cast('2020-12-30T01:42:00' as timestamp)", "2020-12-30T01:42:00", "2020-12-30T01:42"),
                ...
                TestParams.failingCase(2210, TIMESTAMP, TIME, "cast('2020-12-30T01:42:00' as timestamp)",
                        "2020-12-30T01:42:00", "Cannot assign to target field 'this' of type TIME from source field '.+' of type TIMESTAMP"),
                ...
                TestParams.passingCase(2301, TIMESTAMP_WITH_TIME_ZONE, VARCHAR, "cast('2020-12-30T01:42:00-05:00' as timestamp with local time zone)", "2020-12-30T01:42:00-05:00",
                        "2020-12-30T01:42-05:00"),
                ...
                TestParams.failingCase(2307, TIMESTAMP_WITH_TIME_ZONE, DECIMAL, "cast('2020-12-30T01:42:00-05:00' as timestamp with local time zone)",
                        "2020-12-30T01:42:00-05:00", "Cannot assign to target field 'this' of type DECIMAL from source field '.+' of type TIMESTAMP_WITH_TIME_ZONE"),
