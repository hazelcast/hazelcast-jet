...
import com.hazelcast.jet.sql.imap.IMapFilterIntoScanLogicalRule;
import com.hazelcast.jet.sql.imap.IMapFilterLogicalRule;
import com.hazelcast.jet.sql.imap.IMapProjectIntoScanLogicalRule;
import com.hazelcast.jet.sql.imap.IMapProjectLogicalRule;
import com.hazelcast.jet.sql.imap.IMapScanLogicalRule;
...
public class JetLogicalRules {
    ...
    private static final IMapFilterIntoScanLogicalRule FILTER_INTO_SCAN_RULE = IMapFilterIntoScanLogicalRule.INSTANCE;

    /** Rule which merges project and scan. */
    private static final IMapProjectIntoScanLogicalRule PROJECT_INTO_SCAN_RULE = IMapProjectIntoScanLogicalRule.INSTANCE;
