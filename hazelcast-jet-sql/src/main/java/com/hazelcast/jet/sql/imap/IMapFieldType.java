...
enum IMapFieldType {
  ...
  private static final Map<String, IMapFieldType> MAP = new HashMap<>();

  static {
    for (IMapFieldType value : values()) {
      MAP.put(value.simpleName, value);
    }
  }

  IMapFieldType(Primitive primitive) {
    this(primitive.boxClass, primitive.primitiveName);
  }

  IMapFieldType(Class clazz, String simpleName) {
    this.clazz = clazz;
  ...
  public static IMapFieldType of(String typeString) {
