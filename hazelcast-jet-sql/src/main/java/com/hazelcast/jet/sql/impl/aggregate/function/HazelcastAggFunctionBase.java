...
public abstract class HazelcastAggFunctionBase extends SqlAggFunction implements HazelcastOperandTypeCheckerAware {
    public HazelcastAggFunctionBase(
            String name,
            SqlKind kind,
        ...
        super(name, null, kind, returnTypeInference, operandTypeInference, operandTypeChecker, funcType, requiresOrder, requiresOver, requiresGroupOrder);
    }
