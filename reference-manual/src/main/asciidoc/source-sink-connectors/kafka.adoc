...
in case of a failure some records could be produced duplicately. You can
also have the job in exactly-once mode and decrease the guarantee just
for a particular Kafka sink.
