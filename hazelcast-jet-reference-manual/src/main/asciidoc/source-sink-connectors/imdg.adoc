...
1. {jet-javadoc}/pipeline/Sinks.html#mapWithMerging-java.lang.String-com.hazelcast.util.function.FunctionEx-com.hazelcast.util.function.FunctionEx-com.hazelcast.util.function.BinaryOperatorEx-[`mapWithMerging`],
...
2. {jet-javadoc}/pipeline/Sinks.html#mapWithUpdating-java.lang.String-com.hazelcast.util.function.FunctionEx-com.hazelcast.util.function.BiFunctionEx-[`mapWithUpdating`],
...
`mapWithEntryProcessor` if you need the proper locking behavior.
+
3. {jet-javadoc}/pipeline/Sinks.html#mapWithEntryProcessor-java.lang.String-com.hazelcast.util.function.FunctionEx-com.hazelcast.util.function.FunctionEx-[`mapWithEntryProcessor`],
