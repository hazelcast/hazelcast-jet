...
|**executionStartTime**: Start time of the current execution of a job. +
**executionCompletionTime**: Start time of the current execution of a job. +

Both contain epoch time in milliseconds.
|** * only ones without `vertex` tag** +
