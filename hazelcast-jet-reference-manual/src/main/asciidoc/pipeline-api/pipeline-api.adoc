...
{jet-javadoc}/pipeline/SourceBuilder.html#batch-java.lang.String-com.hazelcast.internal.util.function.FunctionEx-[source]
and {jet-javadoc}/pipeline/SinkBuilder.html#sinkBuilder-java.lang.String-com.hazelcast.internal.util.function.FunctionEx-[sink]
...
and
{jet-javadoc}/pipeline/BatchStage.html#flatMap-com.hazelcast.internal.util.function.FunctionEx-[`flatMap`].
...
{jet-javadoc}/pipeline/BatchStage.html#hashJoin-com.hazelcast.jet.pipeline.BatchStage-com.hazelcast.jet.pipeline.JoinClause-com.hazelcast.internal.util.function.BiFunctionEx-[Hash-join]
...
using
{jet-javadoc}/pipeline/GeneralStage.html#groupingKey-com.hazelcast.internal.util.function.FunctionEx-[`groupingKey()`].
...
- {jet-javadoc}/pipeline/StreamSourceStage.html#withTimestamps-com.hazelcast.internal.util.function.ToLongFunctionEx-long-[`withTimestamps(timestampFn)`]
