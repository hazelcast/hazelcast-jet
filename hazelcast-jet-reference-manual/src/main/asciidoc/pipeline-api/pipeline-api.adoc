...
{jet-javadoc}/pipeline/SourceBuilder.html#batch-java.lang.String-com.hazelcast.util.function.FunctionEx-[source]
and {jet-javadoc}/pipeline/SinkBuilder.html#sinkBuilder-java.lang.String-com.hazelcast.util.function.FunctionEx-[sink]
...
{jet-javadoc}/pipeline/BatchStage.html#map-com.hazelcast.util.function.FunctionEx-[`map`],
{jet-javadoc}/pipeline/BatchStage.html#filter-com.hazelcast.util.function.PredicateEx-[`filter`]
and
{jet-javadoc}/pipeline/BatchStage.html#flatMap-com.hazelcast.util.function.FunctionEx-[`flatMap`].
...
{jet-javadoc}/pipeline/BatchStage.html#hashJoin-com.hazelcast.jet.pipeline.BatchStage-com.hazelcast.jet.pipeline.JoinClause-com.hazelcast.util.function.BiFunctionEx-[Hash-join]
...
using
{jet-javadoc}/pipeline/GeneralStage.html#groupingKey-com.hazelcast.util.function.FunctionEx-[`groupingKey()`].
...
- {jet-javadoc}/pipeline/StreamSourceStage.html#withTimestamps-com.hazelcast.util.function.ToLongFunctionEx-long-[`withTimestamps(timestampFn)`]
