...
```bash
wget https://repository.hazelcast.com/download/jet-enterprise/hazelcast-jet-enterprise-4.5.4.tar.gz
tar zxvf hazelcast-jet-enterprise-4.5.4.tar.gz
cd hazelcast-jet-enterprise-4.5.4
```
...
The command mounts the local `examples` directory from `hazelcast-jet-enterprise-4.5.4`
