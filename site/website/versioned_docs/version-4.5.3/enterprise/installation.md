...
```bash
wget https://repository.hazelcast.com/download/jet-enterprise/hazelcast-jet-enterprise-4.5.3.tar.gz
tar zxvf hazelcast-jet-enterprise-4.5.3.tar.gz
cd hazelcast-jet-enterprise-4.5.3
```
...
compile 'com.hazelcast.jet:hazelcast-jet-enterprise:4.5.3'
```
...
The command mounts the local `examples` directory from `hazelcast-jet-enterprise-4.5.3`
