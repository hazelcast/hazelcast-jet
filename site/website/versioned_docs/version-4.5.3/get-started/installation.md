...
tar zxvf hazelcast-jet-4.5.3.tar.gz
```

Alternatively, you can download it from
[here](https://github.com/hazelcast/hazelcast-jet/releases/download/v4.5.3/hazelcast-jet-4.5.3.tar.gz)
