...
- [SELECT and WHERE
expressions](https://docs.hazelcast.org/docs/4.2.2/manual/html-single/index.html#expressions)
...
```groovy
compile 'com.hazelcast.jet:hazelcast-jet-sql:4.5.1'
```
...
on SQL](https://docs.hazelcast.org/docs/4.2.2/manual/html-single/index.html#sql)
