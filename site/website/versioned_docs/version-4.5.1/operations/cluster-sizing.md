...
id: version-4.5.1-cluster-sizing
...
The [Event
Journal](https://docs.hazelcast.org/docs/4.2.2/manual/html-single/index.html#event-journal)
...
detector](https://docs.hazelcast.org/docs/4.2.2/manual/html-single/index.html#failure-detector-configuration)
