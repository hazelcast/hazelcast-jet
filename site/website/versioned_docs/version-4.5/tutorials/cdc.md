...
* hazelcast-jet-cdc-mysql-4.5.jar
* hazelcast-jet-cdc-postgres-4.5.jar
...
dependencies {
    ...
    implementation 'com.hazelcast.jet:hazelcast-jet-cdc-debezium:4.5'
    implementation 'com.hazelcast.jet:hazelcast-jet-cdc-mysql:4.5'
