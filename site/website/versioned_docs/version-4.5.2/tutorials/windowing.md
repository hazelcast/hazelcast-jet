...
dependencies {
    ...
    implementation 'com.hazelcast.jet.examples:hazelcast-jet-examples-trade-source:4.5.2'
}
...
shadowJar {
    dependencies {
        exclude(dependency('com.hazelcast.jet:hazelcast-jet:4.5.2'))
    }
}
```
