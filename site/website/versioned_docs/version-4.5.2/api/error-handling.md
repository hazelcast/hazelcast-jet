...
id: version-4.5.2-error-handling
...
[`JobConfig.setSuspendOnFailure`](/javadoc/4.5.2/com/hazelcast/jet/config/JobConfig.html#setSuspendOnFailure(boolean))
and
[`Job.getSuspensionCause`](/javadoc/4.5.2/com/hazelcast/jet/Job.html#getSuspensionCause()).
