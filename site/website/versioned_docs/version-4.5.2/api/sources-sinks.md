...
id: version-4.5.2-sources-sinks
...
```groovy
compile 'com.hazelcast.jet:hazelcast-jet-avro:4.5.2'
```
...
```groovy
compile 'com.hazelcast.jet:hazelcast-jet-hadoop-all:4.5.2'
```
...
`hazelcast-jet-hadoop-4.5.2.jar` is in the `lib/` directory
).
...
```groovy
compile 'com.hazelcast.jet:hazelcast-jet-hadoop:4.5.2'
```
...
```groovy
compile 'com.hazelcast.jet:hazelcast-jet-s3:4.5.2'
```
...
```groovy
compile 'com.hazelcast.jet:hazelcast-jet-kinesis:4.5.2'
```
...
As of Jet version 4.5.2 we have following types of CDC sources:

* [DebeziumCdcSources](/javadoc/4.5.2/com/hazelcast/jet/cdc/DebeziumCdcSources.html):
  generic source for all databases supported by Debezium
* [MySqlCdcSources](/javadoc/4.5.2/com/hazelcast/jet/cdc/mysql/MySqlCdcSources.html):
...
* [PostgresCdcSources](/javadoc/4.5.2/com/hazelcast/jet/cdc/postgres/PostgresCdcSources.html):
...
```groovy
compile 'com.hazelcast.jet:hazelcast-jet-elasticsearch-7:4.5.2'
```
...
[SourceBuilder](/javadoc/4.5.2/com/hazelcast/jet/pipeline/SourceBuilder.html)
and
[SinkBuilder](/javadoc/4.5.2/com/hazelcast/jet/pipeline/SinkBuilder.html).
