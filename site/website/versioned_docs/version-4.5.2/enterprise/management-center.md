...
id: version-4.5.2-management-center
...
```bash
wget repository.hazelcast.com/download/jet-management-center/hazelcast-jet-management-center-4.5.2.tar.gz
tar zxvf hazelcast-jet-management-center-4.5.2.tar.gz
```
